    ...
    <div className="flex items-center space-x-2 ">
      ...
      <div className="flex-grow">
        <input
          ...
          name="roleAs"
          // id="roleAs"
          className="block pt-3 px-0 w-full text-sm text-white bg-transparent border-b-2 border-t-0 border-x-0 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          placeholder="Role as..."
          value={roleAs}
          onChange={handleOnChange}
        />
      ...
      {/* <label
          ...
          >Role</label> */}
      <button onClick={handleSubmit} type="button" className="bg-[#4997f0] text-white rounded px-2 py-1 hover:opacity-80 mt-3">
        Add
      </button>
    </div>
  );
