...
import { findMangaByName } from '../../api/anime';
...
function GetMangaByName() {
    ...
    const fetchFindAnime =async() =>{
        ...
        const {data} = await findMangaByName(searchAnime);
...
const AnimeMoviesHeader = ({searchAnime,setSearchAnime,onClick})=>{
    ...
    {/* <img className='max-h-[54em]' src="./images/cap_anime2.png" alt="pic" /> */}
        <h1 className='text-center text-[#735dc2]'>Search a Manga To Read</h1>
